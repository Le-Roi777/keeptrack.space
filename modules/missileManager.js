...
(function () {
  ...
  missileManager.asat = (CurrentLatitude, CurrentLongitude, satId, MissileObjectNum, CurrentTime, Length, Diameter, NewBurnRate, AngleCoefficient) => {
      ...
      TargetLongitude = (TargetLongitude < -180) ? TargetLongitude + 360 : TargetLongitude;
      let [timeInFlight2,tgtLat, tgtLon] = missileManager.asatFlight(CurrentLatitude, CurrentLongitude, TargetLatitude, TargetLongitude, satAlt2, NumberWarheads, MissileObjectNum, CurrentTime, MissileDesc, Length, Diameter, NewBurnRate, MaxMissileRange, country, timeInFlight, AngleCoefficient);
      ...
      TargetLongitude = (TargetLongitude > 180) ? TargetLongitude - 360 : TargetLongitude;
      TargetLongitude = (TargetLongitude < -180) ? TargetLongitude + 360 : TargetLongitude;
      let [timeInFlight3,tgtLat2, tgtLon2] = missileManager.asatFlight(CurrentLatitude, CurrentLongitude, TargetLatitude, TargetLongitude, satAlt3, NumberWarheads, MissileObjectNum, CurrentTime, MissileDesc, Length, Diameter, NewBurnRate, MaxMissileRange, country, timeInFlight2, AngleCoefficient);
  ...
  missileManager.asatFlight = function (CurrentLatitude, CurrentLongitude, TargetLatitude, TargetLongitude, targetAltitude, NumberWarheads, MissileObjectNum, CurrentTime, MissileDesc, Length, Diameter, NewBurnRate, MaxMissileRange, country, timeInFlight, AngleCoefficient) {
    // This is the main function for this program. It calculates and designs the flight path of an intercontinental
    // ballistic missile (ICBM). This function calls upon many sub-functions to help it iteratively calculate many of the
    // changing variables as the rocket makes its path around the world. Changing variables that had to be taken into
    // account include:
