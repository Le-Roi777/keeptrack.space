...
(function () {
  ...
  adviceList.welcome = function () {
    ...
    adviceManager.showAdvice("Welcome",
  ...
  adviceList.findISS = function () {
    ...
    adviceManager.showAdvice("Space Station",
  ...
  adviceList.showSensors = function () {
    ...
    adviceManager.showAdvice("Sensor List",
  ...
  adviceList.useLegend = function () {
    ...
    adviceManager.showAdvice("Filters",
  ...
  adviceList.toggleNight = function () {
    ...
    adviceManager.showAdvice("Day/Night Toggle",
  ...
  adviceList.missileMenu = function () {
    ...
    adviceManager.showAdvice("Missile Scenarios",
  ...
  adviceList.satelliteSelected = function () {
    ...
    if (adviceCount.satelliteView < 1) {
      ...
      adviceManager.showAdvice("Create Launch Nominal",
      ...
      adviceManager.showAdvice("Create a Breakup",
      ...
      adviceManager.showAdvice("Edit Satellite",
  ...
  adviceList.colorScheme = function () {
    ...
    adviceManager.showAdvice("Color Schemes",
  ...
  adviceList.countries = function () {
    ...
    adviceManager.showAdvice("Countries Menu",
  ...
  adviceList.socrates = function () {
    ...
    adviceManager.showAdvice("SOCRATES Near Conjunction List",
  ...
  adviceList.cspocSensors = function () {
    ...
    adviceManager.showAdvice("Combined Space Operations Center Sensors",
  ...
  adviceList.mwSensors = function () {
    ...
    adviceManager.showAdvice("USSTRATCOM Missile Warning Sensors",
  ...
  adviceList.customSensors = function () {
    ...
    adviceManager.showAdvice("Custom Sensor",
  ...
  adviceList.planetariumDisabled = function () {
    ...
    adviceManager.showAdvice("Planetarium View",
  ...
  adviceList.satViewDisabled = function () {
    ...
    adviceManager.showAdvice("Satellite View",
  ...
  adviceList.mapDisabled = function () {
    ...
    adviceManager.showAdvice("Stereographic Map",
  ...
  adviceList.lookanglesDisabled = function () {
    ...
    adviceManager.showAdvice("Look Angles",
  ...
  adviceList.ssnLookanglesDisabled = function () {
    ...
    adviceManager.showAdvice("SSN Lookangles",
  ...
  adviceList.survFenceDisabled = function () {
    ...
    adviceManager.showAdvice("Show/Hide Surveillance Fence",
  ...
  adviceList.bubbleDisabled = function () {
    ...
    adviceManager.showAdvice("Show/Hide Field Of View Bubble",
  ...
  adviceList.sensorInfoDisabled = function () {
    ...
    adviceManager.showAdvice("Sensor Information",
  ...
  adviceList.breakupDisabled = function () {
    ...
    adviceManager.showAdvice("Create Breakup",
  ...
  adviceList.satFOVDisabled = function () {
    ...
    adviceManager.showAdvice("Satellite Field of View",
  ...
  adviceList.sensor = function () {
    ...
    if (adviceCount.sensorFOV < 1) {
      ...
      adviceManager.showAdvice("Field Of View Bubbles",
      ...
      adviceManager.showAdvice("Surveillance Fence",
  ...
  tutIconDOM.on('click', function (e) {
    if (isAdviceEnabled) { adviceManager.off(); } else { adviceManager.on(); }
  });
  ...
  adviceManager.showAdvice = function (header, text, focusDOM, setLocation) {
    ...
    switch (setLocation) {
      case 'top-left':
        helpDOM.css({left: '1%', right: 'auto', top: '1%', bottom: 'auto'});
        break;
      case 'left':
        helpDOM.css({left: '1%', right: 'auto', top: '40%', bottom: 'auto'});
        break;
      case 'bottom-left':
        helpDOM.css({left: '1%', right: 'auto', top: 'auto', bottom: '120px'});
        break;
      case 'bottom':
        var leftValue = window.innerWidth / 2 - 175 + 'px';
        helpDOM.css({left: leftValue, right: 'auto', top: 'auto', bottom: '120px'});
        break;
      case 'top-right':
        helpDOM.css({left: 'auto', right: '1%', top: '1%', bottom: 'auto'});
        break;
      case 'right':
        helpDOM.css({left: 'auto', right: '1%', top: '40%', bottom: 'auto'});
        break;
      case 'bottom-right':
        helpDOM.css({left: 'auto', right: '1%', top: 'auto', bottom: '120px'});
        break;
    }
